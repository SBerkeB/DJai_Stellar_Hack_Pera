...
function deploy(wasm) {
  exe(`${cli} contract deploy --wasm ${wasm} --ignore-checks --alias ${filenameNoExtension(wasm)} -- --admin GDLQB2DMKDWPUCSUZEQSER2JAIBTCYXSVBUPKTFJTWKTPGTA6PMXJCEM --apikey "AIzaSyD1dl6nQqqqYeCTXAlkiYAaXXHThDyfXVs"`);
}
