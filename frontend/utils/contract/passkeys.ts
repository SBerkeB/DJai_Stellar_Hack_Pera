...
export const account = new PasskeyKit({
    ...
    walletWasmHash: process.env.NEXT_PUBLIC_WALLET_WASM_HASH as string,
    timeoutInSeconds: 30,
})

export const server = new PasskeyServer({
    rpcUrl: process.env.NEXT_PUBLIC_RPC_URL,
    launchtubeUrl: process.env.VITE_LAUNCHTUBE_URL,
    launchtubeJwt: process.env.VITE_LAUNCHTUBE_JWT,
})
