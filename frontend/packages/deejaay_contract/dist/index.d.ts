...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CDTCCJSV63NAWSX66VQNVU7U7FB4VXNNT7A2WW2WIEOOG2BSV2NZUSJQ";
    };
};
export type DataKey = {
    tag: "Admin";
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        write_user: (json: string) => AssembledTransaction<Result<number, import("@stellar/stellar-sdk/contract").ErrorMessage>>;
        edit_user: (json: string) => AssembledTransaction<Result<void, import("@stellar/stellar-sdk/contract").ErrorMessage>>;
        read_user: (json: string) => AssembledTransaction<Result<User, import("@stellar/stellar-sdk/contract").ErrorMessage>>;
        read_latest: (json: string) => AssembledTransaction<Result<User, import("@stellar/stellar-sdk/contract").ErrorMessage>>;
