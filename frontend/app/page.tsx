...
//       <div className="container mx-auto px-4 py-16 relative" style={{ zIndex: 10 }}>
//         {/* Hero Section */}
...
//           <div className="text-lg text-gray-400 mb-8">Coming Soon • Join the Whitelist for Early Access • Take part in building</div>
//           <div className="text-lg text-gray-400 mb-12">Whitelist Deadline: 30.06.2025</div>
//         </div>

//         {/* Features Section */}
//         <div className="grid md:grid-cols-2 gap-8 mb-16 max-w-4xl mx-auto">
//           <div className="text-center">
//             <div className="bg-gray-900 p-4 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
//               <MessageCircle className="h-8 w-8 text-white" />
//             </div>
//             <h3 className="text-xl font-semibold mb-2">AI Conversations</h3>
//             <p className="text-gray-400">Communicate with the language model.</p>
//           </div>
...
//             </div>
//             <h3 className="text-xl font-semibold mb-2">Live Music Generation</h3>
//             <p className="text-gray-400">Enjoy your unique realtime music.</p>
//           </div>
//         </div>
...
//             Join our exclusive whitelist to get early access when we launch. Experience the future of AI-powered music
//             conversations before anyone else.
//           </p>
...
//               <li>• Real-time AI music generation based on conversation</li>
//               <li>• Seamless crypto wallet integration</li>
//               <li>• Spotify connectivity for enhanced audio experiences</li>
...
//           <p className="text-gray-500">© 2024 AI Chat Hub. All rights reserved.</p>
//         </div>
//       </div>
//     </div>
//   )
...
// //             The future of AI-powered conversations with real-time music generation. Experience the next generation of
// //             interactive AI that creates music as you chat.
// //           </p>
...
// //           <div className="text-lg text-gray-400 mb-8">Coming Soon • Join the Whitelist for Early Access</div>
...
// //             </div>
// //             <h3 className="text-xl font-semibold mb-2">AI Conversations</h3>
// //             <p className="text-gray-400">Engage in intelligent conversations powered by advanced AI technology</p>
// //           </div>
...
// //             </div>
// //             <h3 className="text-xl font-semibold mb-2">Live Music Generation</h3>
// //             <p className="text-gray-400">AI creates unique music in real-time based on your conversation context</p>
// //           </div>
...
// //         {/* Additional Info */}
// //         <div className="text-center mb-16">
// //           <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-sm rounded-2xl p-8 max-w-2xl mx-auto border border-gray-700">
// //             <h3 className="text-xl font-semibold mb-4">What to Expect</h3>
...
// //           <h3 className="text-lg font-semibold mb-4 text-gray-300">Join Our Community</h3>
...
// //             </a>
// //           </div>
// //           <p className="text-gray-500 text-sm">© 2025 AI Chat Hub. All rights reserved.</p>
// //         </div>
// //       </div>
// //     </div>
// //   )
...
import { CountdownTimer } from "@/components/whitelist/countdown-timer"
import { SocialProof } from "@/components/whitelist/social-proof"
import { MusicVisualizer } from "@/components/whitelist/music-visualizer"
import { PulsingLogo } from "@/components/whitelist/pulsing-logo"
import { MessageCircle, Headphones, Zap, DiscIcon as Discord, Twitter } from "lucide-react"
...
=======
  const [selectedSocketPath, setSelectedSocketPath] = useState(socketOptions[1].path);
>>>>>>> Stashed changes
...
=======
    ...
    useEffect(() => {
      ...
      if (!musicWSRef.current) {
        ...
        musicWSRef.current.onmessage = (event: any) => { // TBD: type this properly
          const data = JSON.parse(event.data);
          console.log("Music WebSocket data:", data)
          if (data.serverContent?.audioChunks) {
...
=======
        ...
        <div className="text-center max-w-2xl mx-auto mt-12 p-6 bg-black text-white rounded-2xl shadow-xl border border-white/10 mb-16">
          <h2 className="text-4xl font-extrabold mb-4">🎶 Join the Waitlist 🎶</h2>
          <p className="text-lg mb-6 text-gray-400">Be the first to access the AI DJ experience.</p>
          <p className="text-lg mb-6 text-gray-400">Select your vibe & flex your style.</p>
          ...
          <form className="space-y-6">
            ...
            <div>
              <label className="block text-lg font-bold mb-2">Which worlds do you vibe with?</label>
              <div className="flex flex-wrap gap-2 items-center justify-center">
                {options.map(option => (
                  <label
                    key={option}
                    className={`px-3 py-1 rounded-full  text-sm cursor-pointer hover:bg-pink-500/20
                      ${selectedOptions.includes(option) ? "bg-blue-900 text-white" : "bg-white/10 text-white"}`}
>>>>>>> Stashed changes
                  >
                    <input
                      type="checkbox"
...
<<<<<<< Updated upstream
            ...
            <div>
              ...
              >
=======
              <label htmlFor="flex" className="block text-sm font-medium">Flex your style (optional)</label>
              <textarea id="flex" name="flex" rows={3}
                        className="mt-1 block w-full rounded-xl bg-white/10 border border-white/20 p-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        placeholder="Drop a playlist, GitHub link, Social Media or your AI-DJ collab idea..."></textarea>
            </div>
